...
def user_logged_in_callback(sender, request, user, **kwargs):
    try:
        ...
        messages.add_message(request, messages.INFO, f"Welcome back {user.username}! You were last logged in {previous_login_time} ago from {previous_login.ip_address} with {previous_login.user_agent}")
    except IndexError:
